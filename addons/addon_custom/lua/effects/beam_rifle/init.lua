...
EFFECT.Mat = Material( "effects/beam_rif_beam" )
...
function EFFECT:Think( )
	...
	self.FlashA = self.FlashA - 3500 * FrameTime()
	if (self.FlashA < 0) then self.FlashA = 0 end

	self.Alpha = self.Alpha - 3500 * FrameTime()
...
function EFFECT:Render( )
	...
	local texcoord = self.texcoord
		...
		render.DrawBeam( self.StartPos, 										// Start
					 ...
					 Color( 225, 255, 255, math.Clamp(self.Alpha, 0,255)) )		// Color (optional)'
