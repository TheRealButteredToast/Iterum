function EFFECT:Init(data)
	...
	if emitter != nil then	
		local particle = emitter:Add( "effects/smg_muzzle", self.Position - self.Forward * 0 )
		if particle != nil then
			...
			particle:SetRoll( math.Rand( 10, 106 ) )
			particle:SetRollDelta( math.Rand( 3, 3 ) )
			
			particle:SetColor( 255, 185, 149 )
		
		for i = 1,4 do
			local particle = emitter:Add( "effects/smg_muzzle", self.Position )
				...
				particle:SetRoll( math.Rand( -25, 265 ) )
