function EFFECT:Init(data)
	...
	if emitter != nil then	
		local particle = emitter:Add( "muzzles/ar", self.Position - self.Forward * 0 )
		if particle != nil then
			...
			particle:SetStartSize( math.random( 15, 15 ) )
		...
		for i = 1,4 do
			local particle = emitter:Add( "muzzles/ar", self.Position )
