...
SWEP.InfoDescription	= "Adopted into the UNSC in 2525, the BR55 is a mid-long range combat rifle that was \n just as quickly adopted by insurrection groups as it was introduced to military service."
...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/vuthakral/halo/weapons/c_hum_br55.mdl"
SWEP.WorldModel			= "models/vuthakral/halo/weapons/w_br55.mdl"
SWEP.VMPos 				= Vector(0, 3, 0)
SWEP.VMAng 				= Vector(2.5, 0, 0)
...
SWEP.VElements = {
	["ammo_counterV"] = { type = "Quad", bone = "gun", rel = "", pos = Vector(3.15, 0, 5.99), angle = Angle(0, -90, 60), size = 0.009, draw_func = nil}
}

SWEP.WElements = {
	["ammo_counterW"] = { type = "Quad", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.25, 0.8, -5.265), angle = Angle(0, 90, -100), size = 0.009, draw_func = nil}
}
