...
SWEP.PrintName			= "M90 Mk I"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_shotgun"

SWEP.Manufacturer		= "Weapon System Technologies"
SWEP.InfoName			= "Shotgun"
SWEP.InfoDescription	= "The M90 is an adapted military variant of the DTM-series of shotguns with\n a reputation for dismembering the overwhelming odds."
...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/vuthakral/halo/weapons/c_hum_m90_ce.mdl"
SWEP.WorldModel			= "models/vuthakral/halo/weapons/w_m90ce.mdl"
SWEP.VMPos 				= Vector(0, 3, -0.5)
SWEP.VMAng 				= Vector(0, 0, 0)
SWEP.VMPosCrouch		= Vector(0, -4, 0.4)
SWEP.VMAngCrouch		= Vector(0, 0, 0)
SWEP.IronSightsPos 		= Vector(-3.4, 0, 1)
...
SWEP.Primary.Sound			= Sound("drc.m90ce_fire")
