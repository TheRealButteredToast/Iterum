ITEM.name = "UNSC Lieutenant Uniform"
ITEM.bgs = "015551230322" -- 1550230322
ITEM.bgsr= "000000000000"
ITEM.desc = "UNSC Lieutenant Uniform | +25 Armor" 
ITEM.reqMols = {
	...
	"models/ishi/halo_rebirth/player/marines/male/marine_jeffrey.mdlmodels/ishi/halo_rebirth/player/marines/male/marine_jeffrey.mdl",
