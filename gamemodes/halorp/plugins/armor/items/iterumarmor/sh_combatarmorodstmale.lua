ITEM.name = "Combat Armor ODST Male"
ITEM.desc = "CHA -1 | DEX -1 | CON + 3 | 135 Armor"
ITEM.model = "models/ishi/halo_rebirth/props/human/oni_crate_small.mdl"
ITEM.price = 2460
ITEM.value = 135
ITEM.atr = {cha = -1, dex = -1, con = 3}
ITEM.models =  {
	-- Male ODST Models
...
ITEM.badModels = {
	...
	"models/ishi/suno/halo_rebirth/player/innie/female/innie_razer.mdl",
	-- Aliens
	"models/vuthakral/halo/custom/usp/sangheili_universal_player.mdl", 	-- Elite
	"models/valk/haloreach/covenant/characters/grunt/grunt_player.mdl", -- Grunt
	"models/player/jackal.mdl",											-- Jackal
	"models/valk/haloreach/covenant/characters/brute/brute.mdl", 		-- Brute
}