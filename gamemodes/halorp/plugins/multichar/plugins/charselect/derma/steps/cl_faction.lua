...
function PANEL:Init()
	self.title = self:addLabel("Please confirm your Race")
...
function PANEL:onFactionSelected(faction)
	...
	self.desc:SetText("Welcome to Asphodel! As you work through the survey, makesure to carefully consider your selections. You will not be given a second chance to update our records! Upon completion of the survey, your immigration status will be updated and you shall be released unto Asphodel.")
