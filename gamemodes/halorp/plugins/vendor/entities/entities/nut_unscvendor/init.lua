...
function ENT:SpawnFunction(client, trace)
	...
	local entity = ents.Create("nut_unscvendor")
...
function ENT:Use(activator)
	...
	if !activator:getChar():hasFlags('N') and !activator:getChar():hasFlags('O') then
		activator:ChatPrint("You are not a member of the UNSC!")
		return
	end
