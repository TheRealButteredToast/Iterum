...
function ENT:SpawnFunction(client, trace)
	...
	local entity = ents.Create("nut_policevendor")
...
function ENT:Use(activator)
	...
	if !activator:getChar():hasFlags('B') and !activator:getChar():hasFlags('b') then
		activator:ChatPrint("You are not a member of the Police!")
		return
	end
