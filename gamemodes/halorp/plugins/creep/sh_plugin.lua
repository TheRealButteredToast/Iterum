...
PLUGIN.desc = "Friendly Friends who do Friendly things to Friendly people in very Friendly ways because they are so Friendly."
...
nut.command.add("cleancreep", {
	...
	onRun = function(client, arguments)
		...
		client:notify("Cleaned all Growth.")
	end
})
