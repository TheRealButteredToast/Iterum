...
if (SERVER) then
	...
	function ENT:Use(client)
		client:SendLua("gui.OpenURL('https://discord.gg/fsmzw5p')")
	end
else
	local text = L"Discord Board"
	local textLen = utf8.len(text)
	local textTable = {}

	local text2 = L"Join our Discord!"
	...
	local function renderCode(self, ent, w, h)
		textTable = {}
		textTable2 = {}
		text = L"Discord Board"
		text2 = L"Join our Discord!"
