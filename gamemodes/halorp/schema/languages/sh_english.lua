LANGUAGE = {
	...
	*/
	...
	advert  = "[Advert] ",
	jobVoteContext = "Vote For or Against %s to become %s?",
	demoteContext = "Do you agree to demote %s from %s? (%s)",
	foodVendorButton = "Purchase food",
	wantedNotify = "%s is now Wanted! (%s)",
	arrestNotify = "%s has been arrested by %s.",
	warrantNofity = "%s has issued a search warrant on %s.",
	warrantEndNofity = "%s's search warrant has been recalled by %s.",
